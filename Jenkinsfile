  ...
  volumes: [
	...
	stage('kubernetes Deployment') {
            ...
            container('kubectl') {
                 ...
                 // create a new one
                 sh "kubectl create --dry-run=true -o yaml -f ${WORKSPACE}/deployment.yaml | kubectl apply -f -"
                //  sh "kubectl apply -f ${WORKSPACE}/deployment.yaml"
                 ...
                 sh "kubectl create --dry-run=true -o yaml -f ${WORKSPACE}/service.yaml | kubectl apply -f -"
